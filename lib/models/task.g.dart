...
const TaskSchema = CollectionSchema(
  ...
  links: {
    r'tags': LinkSchema(
      id: -4257306112485755755,
      name: r'tags',
      target: r'Tag',
      single: false,
    ),
    r'timelogs': LinkSchema(
      id: 5366329526518007855,
      name: r'timelogs',
      target: r'Timelog',
      single: false,
      linkName: r'task',
...
List<IsarLinkBase<dynamic>> _taskGetLinks(Task object) {
  return [object.tags, object.timelogs];
}

void _taskAttach(IsarCollection<dynamic> col, Id id, Task object) {
  object.id = id;
  object.tags.attach(col, col.isar.collection<Tag>(), r'tags', id);
  object.timelogs.attach(col, col.isar.collection<Timelog>(), r'timelogs', id);
}
...
extension TaskQueryLinks on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> tags(FilterQuery<Tag> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> timelogs(
      FilterQuery<Timelog> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'timelogs');
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> timelogsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'timelogs', length, true, length, true);
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> timelogsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'timelogs', 0, true, 0, true);
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> timelogsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'timelogs', 0, false, 999999, true);
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> timelogsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'timelogs', 0, true, length, include);
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> timelogsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'timelogs', length, include, 999999, true);
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition> timelogsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'timelogs', lower, includeLower, upper, includeUpper);
    });
  }
}
